  ...
  return (
    <div>
      <div className="moreinfo">
        <Moreinfoanimation />
        <div className="moreinfo__text">Więcej informacji znajdziesz</div>
        <div className="moreinfo__wrapper">
          <div className="moreinfo__result">
            ...
            <div className="moreinfo__result-circle">
              <div className="moreinfo__result-circle--box">
                ...
                <div className="moreinfo__result-circle--box---text">
                  Wyniki i statystyki
                </div>
                <div className="moreinfo__result-circle--box---textunder">
                  Zapraszam
                </div>
              </div>
              <div className="moreinfo__result-circle--btn">
                <Mybutton style={style.btn} onClick={goToResults}>
                  zobacz
                </Mybutton>
              </div>
            </div>
          ...
          <div className="moreinfo__trip tripGrid">
            <div className="moreinfo__trip-btn flightIconRight"></div>
            <div className="moreinfo__trip-circle tripBox">
              <div className="moreinfo__trip-circle--box">
                <FlightIcon style={style.win} />
                <div className="moreinfo__trip-circle--box---text">
                  Opis wyścigów i rezultaty
                </div>
                <div className="moreinfo__trip-circle--box---textunder">
                  Zapraszam
                </div>
              </div>
