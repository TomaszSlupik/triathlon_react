            ...
            <div className="carousel__box-slide">
              <SwiperSlide>
                <img
                  ...
                  src={process.env.PUBLIC_URL + "/img/carouselone.jpeg"}
                  alt="zawody indoor triathlon - pływanie"
                />
              ...
              <SwiperSlide>
                <img
                  className="carousel__box-slide"
                  src={process.env.PUBLIC_URL + "/img/carouseltwo.JPG"}
                  alt="susz triathlon"
                />
                <div className="carousel__box-signature">
                  Foto. Susz Triathlon
