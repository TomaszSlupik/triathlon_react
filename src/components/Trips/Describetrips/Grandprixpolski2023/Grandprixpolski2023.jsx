    ...
    <div>
        ...
        <Myscrollbox />
            <div className="grandprix__box">
                ...
                <Cardflex data-aos="fade-left">
                    ...
                    <Halfbox>
                        <TextDescribebox>
                            ...
                            lekkoatletycznym (ul. Budowlana 2A, Mińsk Mazowiecki). Pakiet startowy odebrałem o godz. 10:00. Etap pływacki zaplanowany był na godzinę 11:15. 
                        </TextDescribebox>
                        </Halfbox>
                </Cardflex>
                ...
                <TextDescribebox >
                   Przed startem, zrobiłem rozpływanie 300 m w luźnym tempie. Następnie 4x 25 m szybkich odcinków i tak zakończyłem rozgrzewkę. Pływanie, od pierwszych 25m od razu zacząłem bardzo mocno, pierwsze 200 m minęło szybko. 
                   Całe 400 m przepłynąłem w tempie 1:17/100 m co dało wyniki 05:11 i pierwsze miejsce w swojej serii startowej. Po pływaniu mieliśmy 2h na przebranie się i dojechanie na stadion, gdzie czekało na nas 5 000 m na stadionie lekkoatletycznym.
                </TextDescribebox>
                </div>
                ...
                <Cardflex data-aos="fade-right">
                    <img className='maraton__box-map' src={process.env.PUBLIC_URL + '/img/img_2023/aquathlonThree.jpg'} alt="wynik biegania" />
                    <img className='maraton__box-map four' src={process.env.PUBLIC_URL + '/img/img_2023/aquathlon.JPG'} alt="logo Aquathlon" />
                </Cardflex>
